...
import { analyzeContent, type SEOAnalysis } from "@/services/ai/seoWritingAssistant";
    ...
    return (
        <div className="min-h-screen flex flex-col">
            <DashboardHeader
                ...
                subtitle="Real-time content optimization and readability analysis"
            />
            <div className="max-w-[1600px] mx-auto space-y-10 pt-8 pb-20 px-4 md:px-8">
                    ...
                    <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-950 border border-white/10 p-8 md:p-12">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-5xl md:text-6xl font-black text-white tracking-tight mb-6">
                                SEO Writing <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-violet-300 to-purple-400 bg-[length:200%_auto] animate-gradient drop-shadow-[0_0_15px_rgba(139,92,246,0.3)]">Assistant</span>
                            </h1>
                            <p className="text-slate-400 text-lg font-medium max-w-2xl mb-10 leading-relaxed">
                                ...
                                Our neural editor analyzes readability, keyword intent, and semantic relevance in real-time.
                            </p>
